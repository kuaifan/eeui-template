...
__vue_options__.__file = "/Users/GAOYI/wwwroot/eeui/eeui-template/src/pages/module_captcha.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6f36c8aa"
...
exports.default = {
    methods: {
        ...
        swipeCaptcha: function swipeCaptcha() {
            eeui.swipeCaptcha(null, function (res) {
                switch (res.status) {
                    case "success":
                        eeui.toast("验证成功");
                        break;
