...
__vue_options__.__file = "/Users/GAOYI/wwwroot/eeui/eeui-template/src/pages/index.vue"
...
exports.default = {
    data: function data() {
        return {
            components: [{
                ...
                title_en: 'banner',
                icon: 'md-easel',
                url: _common.jshome + 'component_banner.js'
            }, {
                title: '常用按钮',
                title_en: 'button',
                icon: 'logo-youtube',
                url: _common.jshome + 'component_button.js'
            }, {
                title: '网格容器',
                title_en: 'grid',
                icon: 'md-grid',
                url: _common.jshome + 'component_grid.js'
            }, {
                title: '字体图标',
                title_en: 'icon',
                icon: 'logo-ionic',
                url: _common.jshome + 'component_icon.js'
            }, {
                title: '跑马文字',
                title_en: 'marquee',
                icon: 'md-code-working',
                url: _common.jshome + 'component_marquee.js'
            }, {
                title: '导航栏',
                title_en: 'navbar',
                icon: 'md-menu',
                url: _common.jshome + 'component_navbar.js'
            }, {
                title: '列表容器',
                title_en: 'scroll-view',
                icon: 'md-list',
                url: _common.jshome + 'component_list.js'
            }, {
                title: '滚动文字',
                title_en: 'scroll-text',
                icon: 'ios-more',
                url: _common.jshome + 'component_scroll_text.js'
            }, {
                title: '侧边栏',
                title_en: 'side-panel',
                icon: 'md-albums',
                url: _common.jshome + 'component_side_panel.js'
            }, {
                title: '标签页面',
                title_en: 'tabbar',
                icon: 'md-filing',
                url: _common.jshome + 'component_tabbar.js'
            }],
            ...
            uis: [{
                ...
                title_en: 'w-echarts',
                icon: 'md-trending-up',
                url: _common.jshome + 'ui_echarts.js'
            }, {
                title: 'Switch开关',
                title_en: 'w-switch',
                icon: 'md-switch',
                url: _common.jshome + 'ui_switch.js'
            }],
            ...
            module: [{
                ...
                title_en: 'newPage',
                icon: 'md-book',
                url: _common.jshome + 'module_page.js'
            }, {
                title: '系统信息',
                title_en: 'system',
                icon: 'ios-cog',
                url: _common.jshome + 'module_system.js'
            }, {
                title: '数据缓存',
                title_en: 'caches',
                icon: 'md-beaker',
                url: _common.jshome + 'module_caches.js'
            }, {
                title: '确认对话框',
                title_en: 'alert',
                icon: 'md-alert',
                url: _common.jshome + 'module_alert.js'
            }, {
                title: '等待弹窗',
                title_en: 'loading',
                icon: 'tb-loading',
                url: _common.jshome + 'module_loading.js'
            }, {
                title: '验证弹窗',
                title_en: 'captcha',
                icon: 'md-checkmark-circle',
                url: _common.jshome + 'module_captcha.js'
            }, {
                title: '二维码扫描',
                title_en: 'scaner',
                icon: 'tb-scan',
                url: _common.jshome + 'module_scaner.js'
            }, {
                title: '跨域异步请求',
                title_en: 'ajax',
                icon: 'md-git-pull-request',
                url: _common.jshome + 'module_ajax.js'
            }, {
                title: '剪切板',
                title_en: 'clipboard',
                icon: 'md-copy',
                url: _common.jshome + 'module_plate.js'
            }, {
                title: '提示消息',
                title_en: 'toast',
                icon: 'md-notifications',
                url: _common.jshome + 'module_toast.js'
            }, {
                title: '广告弹窗',
                title_en: 'adDialog',
                icon: 'logo-buffer',
                url: _common.jshome + 'module_ad_dialog.js'
            }],
            ...
            plugin: [{
                ...
                title_en: 'citypicker',
                icon: 'md-pin',
                url: _common.jshome + 'plugin_citypicker.js'
            }, {
                title: '图片选择器',
                title_en: 'picture',
                icon: 'md-camera',
                url: _common.jshome + 'plugin_picture.js'
            }, {
                title: '组件截图',
                title_en: 'screenshots',
                icon: 'md-crop',
                url: _common.jshome + 'plugin_screenshots.js'
            }, {
                title: '融云通信模块',
                title_en: 'rongim',
                icon: 'tb-community',
                url: _common.jshome + 'plugin_rongim.js'
            }, {
                title: '友盟推送模块',
                title_en: 'umeng',
                icon: 'md-send',
                url: _common.jshome + 'plugin_umeng.js'
            }, {
                title: '第三方支付(微信/支付宝)',
                title_en: 'pay',
                icon: 'tb-sponsor',
                url: _common.jshome + 'plugin_pay.js'
            }, {
                title: '即时通讯',
                title_en: 'websocket',
                icon: 'md-repeat',
                url: _common.jshome + 'plugin_websocket.js'
            }],
    ...
    mounted: function mounted() {
        this.history = (0, _global.jsonParse)(eeui.getCachesString("scaner", []), []);
        //
    ...
    methods: {
        scaner: function scaner() {
            ...
            eeui.openScaner(null, function (res) {
                if (res.status === "success") {
                    ...
                    eeui.setCachesString("scaner", (0, _global.jsonStringify)(_this.history), 0);
        ...
        clearHistory: function clearHistory() {
            ...
            eeui.confirm({
                ...
                if (result.status === "click" && result.title === "确定") {
                    _this2.history = [];
                    eeui.setCachesString("scaner", (0, _global.jsonStringify)(_this2.history), 0);
                }
            });
        },
        ...
        openWeb: function openWeb(url) {
            (0, _common.openViewUrl)(url);
        },
        openThird: function openThird(url) {
            (0, _common.openViewCode)("module/third/" + url);
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["list-title"]
  }, [_vm._v("关于 About EEUI")]), _vm._l((_vm.about_lists), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: ["list-item"],
      on: {
