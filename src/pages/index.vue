...
<script>
    ...
    export default {
        data() {
            return {
                ...
                uis: [{
                    ...
                    title_en: 'w-echarts',
                    icon: 'md-trending-up',
                    url: jshome + 'ui_echarts.js',
                },{
                    title: 'Switch开关',
                    title_en: 'w-switch',
                    icon: 'md-switch',
                    url: jshome + 'ui_switch.js',
                }],
        ...
        mounted() {
            this.history = jsonParse(eeui.getCachesString("scaner", []), []);
            //
            ...
            scaner() {
                eeui.openScaner(null, (res) => {
                    if (res.status === "success") {
                        ...
                        eeui.setCachesString("scaner", jsonStringify(this.history), 0);
