...
import app.eeui.framework.extend.integration.glide.load.data.AssetFileDescriptorLocalUriFetcher;
import app.eeui.framework.extend.integration.glide.load.data.DataFetcher;
import app.eeui.framework.extend.integration.glide.load.data.FileDescriptorLocalUriFetcher;
import app.eeui.framework.extend.integration.glide.load.data.StreamLocalUriFetcher;
 ...
 * {@link app.eeui.framework.extend.integration.glide.load.model.ModelLoader} that handles
 * {@link app.eeui.framework.extend.integration.glide.load.model.GlideUrl}s.
 *
