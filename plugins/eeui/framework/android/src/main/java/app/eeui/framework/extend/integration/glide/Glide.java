...
import app.eeui.framework.extend.integration.glide.load.data.InputStreamRewinder;
import app.eeui.framework.extend.integration.glide.load.engine.Engine;
...
import app.eeui.framework.extend.integration.glide.load.engine.prefill.BitmapPreFiller;
import app.eeui.framework.extend.integration.glide.load.engine.prefill.PreFillType;
import app.eeui.framework.extend.integration.glide.load.model.AssetUriLoader;
import app.eeui.framework.extend.integration.glide.load.model.ByteArrayLoader;
import app.eeui.framework.extend.integration.glide.load.model.ByteBufferEncoder;
import app.eeui.framework.extend.integration.glide.load.model.ByteBufferFileLoader;
...
import app.eeui.framework.extend.integration.glide.load.model.MediaStoreFileLoader;
import app.eeui.framework.extend.integration.glide.load.model.ResourceLoader;
import app.eeui.framework.extend.integration.glide.load.model.StreamEncoder;
import app.eeui.framework.extend.integration.glide.load.model.StringLoader;
import app.eeui.framework.extend.integration.glide.load.model.UnitModelLoader;
import app.eeui.framework.extend.integration.glide.load.model.UriLoader;
import app.eeui.framework.extend.integration.glide.load.model.UrlUriLoader;
import app.eeui.framework.extend.integration.glide.load.model.stream.HttpGlideUrlLoader;
import app.eeui.framework.extend.integration.glide.load.model.stream.HttpUriLoader;
import app.eeui.framework.extend.integration.glide.load.model.stream.MediaStoreImageThumbLoader;
import app.eeui.framework.extend.integration.glide.load.model.stream.MediaStoreVideoThumbLoader;
import app.eeui.framework.extend.integration.glide.load.model.stream.UrlLoader;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.BitmapDrawableDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.BitmapDrawableEncoder;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.BitmapEncoder;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.DefaultImageHeaderParser;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.Downsampler;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.ResourceBitmapDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.StreamBitmapDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.UnitBitmapDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.VideoDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.bytes.ByteBufferRewinder;
import app.eeui.framework.extend.integration.glide.load.resource.drawable.ResourceDrawableDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.drawable.UnitDrawableDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.file.FileDecoder;
...
import app.eeui.framework.extend.integration.glide.load.resource.gif.GifFrameResourceDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.gif.StreamGifDecoder;
import app.eeui.framework.extend.integration.glide.load.resource.transcode.BitmapBytesTranscoder;
import app.eeui.framework.extend.integration.glide.load.resource.transcode.BitmapDrawableTranscoder;
import app.eeui.framework.extend.integration.glide.load.resource.transcode.DrawableBytesTranscoder;
import app.eeui.framework.extend.integration.glide.load.resource.transcode.GifDrawableBytesTranscoder;
import app.eeui.framework.extend.integration.glide.manager.ConnectivityMonitorFactory;
import app.eeui.framework.extend.integration.glide.manager.RequestManagerRetriever;
import app.eeui.framework.extend.integration.glide.module.ManifestParser;
import app.eeui.framework.extend.integration.glide.request.RequestOptions;
import app.eeui.framework.extend.integration.glide.request.target.ImageViewTargetFactory;
 ...
 * {@link app.eeui.framework.extend.integration.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private static void initializeGlide(@NonNull Context context, @NonNull GlideBuilder builder) {
    ...
    List<app.eeui.framework.extend.integration.glide.module.GlideModule> manifestModules = Collections.emptyList();
    ...
    if (annotationGeneratedModule != null
      ...
      Iterator<app.eeui.framework.extend.integration.glide.module.GlideModule> iterator = manifestModules.iterator();
      while (iterator.hasNext()) {
        app.eeui.framework.extend.integration.glide.module.GlideModule current = iterator.next();
    ...
    if (Log.isLoggable(TAG, Log.DEBUG)) {
      for (app.eeui.framework.extend.integration.glide.module.GlideModule glideModule : manifestModules) {
    ...
    for (app.eeui.framework.extend.integration.glide.module.GlideModule module : manifestModules) {
    ...
    try {
      Class<GeneratedAppGlideModule> clazz =
          (Class<GeneratedAppGlideModule>)
              Class.forName("app.eeui.framework.extend.integration.glide.GeneratedAppGlideModuleImpl");
  ...
  /**
   * Returns the {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} used to
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.ResourceDecoder}s and
   * {@link app.eeui.framework.extend.integration.glide.load.Transformation}s. Use outside of these classes is not generally
   * recommended. </p>
   */
  @NonNull
  ...
  /**
   * Pre-fills the {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} using the given
   * sizes.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.engine.prefill.PreFillType.Builder Builders} representing
