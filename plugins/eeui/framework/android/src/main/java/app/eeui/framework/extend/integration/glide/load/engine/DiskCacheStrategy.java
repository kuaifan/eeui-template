...
public abstract class DiskCacheStrategy {
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.data.DataFetcher} and the
   * {@link app.eeui.framework.extend.integration.glide.load.EncodeStrategy} of the
   * {@link app.eeui.framework.extend.integration.glide.load.ResourceEncoder} (if an
   * {@link app.eeui.framework.extend.integration.glide.load.ResourceEncoder} is available).
   */
   ...
   * app.eeui.framework.extend.integration.glide.load.ResourceEncoder} will use to encode the resource.
   */
