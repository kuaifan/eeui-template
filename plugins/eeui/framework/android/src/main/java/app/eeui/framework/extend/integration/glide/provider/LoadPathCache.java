...
import app.eeui.framework.extend.integration.glide.load.resource.transcode.UnitTranscoder;
 ...
 * {@link app.eeui.framework.extend.integration.glide.load.engine.LoadPath}s capable of decoding with the requested types.
 */
