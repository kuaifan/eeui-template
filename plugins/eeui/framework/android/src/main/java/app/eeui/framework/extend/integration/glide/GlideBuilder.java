...
import app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.LruArrayPool;
import app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.LruBitmapPool;
import app.eeui.framework.extend.integration.glide.load.engine.cache.DiskCache;
import app.eeui.framework.extend.integration.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import app.eeui.framework.extend.integration.glide.load.engine.cache.LruResourceCache;
import app.eeui.framework.extend.integration.glide.load.engine.cache.MemoryCache;
import app.eeui.framework.extend.integration.glide.load.engine.cache.MemorySizeCalculator;
...
import app.eeui.framework.extend.integration.glide.manager.DefaultConnectivityMonitorFactory;
import app.eeui.framework.extend.integration.glide.manager.RequestManagerRetriever;
import app.eeui.framework.extend.integration.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link app.eeui.framework.extend.integration.glide.load.engine.cache.MemoryCache} implementation to store
   * {@link app.eeui.framework.extend.integration.glide.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link app.eeui.framework.extend.integration.glide.load.engine.cache.DiskCache} implementation to use to store
   * {@link app.eeui.framework.extend.integration.glide.load.engine.Resource} data and thumbnails.
   *
   ...
   * use {@link #setDiskCache(app.eeui.framework.extend.integration.glide.load.engine.cache.DiskCache.Factory)} instead.
  ...
  /**
   * Sets the {@link app.eeui.framework.extend.integration.glide.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link app.eeui.framework.extend.integration.glide.load.engine.cache.DiskCache} to use to store {@link
   * app.eeui.framework.extend.integration.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving
   * {@link app.eeui.framework.extend.integration.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link app.eeui.framework.extend.integration.glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.resource.gif.GifDrawable} or
  ...
  /**
   * Sets the {@link app.eeui.framework.extend.integration.glide.load.DecodeFormat} that will be the default format for all
   ...
   * app.eeui.framework.extend.integration.glide.load.DecodeFormat} for more details. </p>
   *
  ...
  /**
   * Sets the {@link app.eeui.framework.extend.integration.glide.manager.ConnectivityMonitorFactory}
   * to use to notify {@link app.eeui.framework.extend.integration.glide.RequestManager} of connectivity events.
   * If not set {@link app.eeui.framework.extend.integration.glide.manager.DefaultConnectivityMonitorFactory} would be used.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.request.target.Target}s which are subsequently de-referenced and
   ...
   * load resources into {@link app.eeui.framework.extend.integration.glide.request.target.Target}s and then never clear the
   * {@link app.eeui.framework.extend.integration.glide.request.target.Target}. To do so, Glide uses
   * {@link java.lang.ref.WeakReference}s to track resources that belong to
   * {@link app.eeui.framework.extend.integration.glide.request.target.Target}s that haven't yet been cleared. Setting
   * this method to {@code true} allows Glide to also maintain a hard reference to the underlying
   * resource so that if the {@link app.eeui.framework.extend.integration.glide.request.target.Target} is garbage collected,
   ...
   * resources into {@link app.eeui.framework.extend.integration.glide.request.target.Target}s but never clear them.
   *
   ...
   * clear the corresponding {@link app.eeui.framework.extend.integration.glide.request.target.Target} used to load the
   ...
   * {@link app.eeui.framework.extend.integration.glide.request.target.Target}s when you're done with the corresponding
   * resource. Clearing {@link app.eeui.framework.extend.integration.glide.request.target.Target}s allows Glide to maximize
