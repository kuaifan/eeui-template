 ...
 *
 * @see app.eeui.framework.extend.integration.glide.manager.RequestManagerFragment
...
public class SupportRequestManagerFragment extends Fragment {
  ...
  /**
   * Returns the current {@link app.eeui.framework.extend.integration.glide.RequestManager} or null if none is put.
   */
  @Nullable
