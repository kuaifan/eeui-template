...
/**
 * A class that allows {@link app.eeui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link app.eeui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
