 ...
 * {@link app.eeui.framework.extend.integration.glide.GlideBuilder} and registering
 * {@link app.eeui.framework.extend.integration.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, app.eeui.framework.extend.integration.glide.load.ResourceDecoder)} for each
 * {@link app.eeui.framework.extend.integration.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 * <pre>
 *                  {@code
 *                      -keepnames class * app.eeui.framework.extend.integration.glide.samples.flickr.FlickrGlideModule
 *                  }
 *              </pre>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="app.eeui.framework.extend.integration.glide.samples.flickr.FlickrGlideModule"
