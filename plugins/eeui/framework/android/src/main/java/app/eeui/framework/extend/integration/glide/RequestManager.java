...
import static app.eeui.framework.extend.integration.glide.request.RequestOptions.decodeTypeOf;
...
import app.eeui.framework.extend.integration.glide.manager.Lifecycle;
import app.eeui.framework.extend.integration.glide.manager.LifecycleListener;
import app.eeui.framework.extend.integration.glide.manager.RequestManagerTreeNode;
import app.eeui.framework.extend.integration.glide.manager.RequestTracker;
import app.eeui.framework.extend.integration.glide.manager.TargetTracker;
...
public class RequestManager implements LifecycleListener,
   ...
   * app.eeui.framework.extend.integration.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
   ...
   * app.eeui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#DATA}. As a result, specifying a
   * {@link app.eeui.framework.extend.integration.glide.load.engine.DiskCacheStrategy} on this request is generally not
   * recommended.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.ResourceDecoder}s
