...
public final class DrawableTransitionOptions extends
   ...
   *
   * @see app.eeui.framework.extend.integration.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see app.eeui.framework.extend.integration.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
