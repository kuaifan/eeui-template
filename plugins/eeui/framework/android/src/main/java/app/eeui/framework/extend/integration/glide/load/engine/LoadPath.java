...
/**
 * For a given {@link app.eeui.framework.extend.integration.glide.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more
 * {@link app.eeui.framework.extend.integration.glide.load.engine.DecodePath}s.
 *
