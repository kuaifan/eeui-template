...
import static app.eeui.framework.extend.integration.glide.request.RequestOptions.diskCacheStrategyOf;
import static app.eeui.framework.extend.integration.glide.request.RequestOptions.signatureOf;
import static app.eeui.framework.extend.integration.glide.request.RequestOptions.skipMemoryCacheOf;
...
import app.eeui.framework.extend.integration.glide.request.ErrorRequestCoordinator;
import app.eeui.framework.extend.integration.glide.request.FutureTarget;
import app.eeui.framework.extend.integration.glide.request.Request;
import app.eeui.framework.extend.integration.glide.request.RequestCoordinator;
import app.eeui.framework.extend.integration.glide.request.RequestFutureTarget;
...
import app.eeui.framework.extend.integration.glide.request.ThumbnailRequestCoordinator;
import app.eeui.framework.extend.integration.glide.request.target.PreloadTarget;
...
import app.eeui.framework.extend.integration.glide.signature.ApplicationVersionSignature;
...
public class RequestBuilder<TranscodeType> implements Cloneable,
   ...
   * app.eeui.framework.extend.integration.glide.load.model.ModelLoader}, {@link app.eeui.framework.extend.integration.glide.load.ResourceDecoder},
   * and {@link app.eeui.framework.extend.integration.glide.load.Transformation}s. However,
   * {@link app.eeui.framework.extend.integration.glide.request.RequestOptions#placeholder(int)} and
   * {@link app.eeui.framework.extend.integration.glide.request.RequestOptions#error(int)}, and
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.model.ModelLoader} or
   * {@link app.eeui.framework.extend.integration.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.request.RequestOptions#signature(app.eeui.framework.extend.integration.glide.load.Key)} to
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} and/or
   * {@link app.eeui.framework.extend.integration.glide.request.RequestOptions#skipMemoryCache(boolean)} may be
   * appropriate.
   * </p>
   *
   * @see #load(Object)
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * {@link app.eeui.framework.extend.integration.glide.request.RequestOptions#signature(app.eeui.framework.extend.integration.glide.load.Key)}
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link app.eeui.framework.extend.integration.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * using {@link app.eeui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} via
   * {@link RequestOptions#diskCacheStrategy(app.eeui.framework.extend.integration.glide.load.engine.DiskCacheStrategy)}
   * during development, and re-enabling the default
   * {@link app.eeui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.Transformation}s to these {@link Drawable}s by either extracting
   ...
   * transformed (other than {@link app.eeui.framework.extend.integration.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link app.eeui.framework.extend.integration.glide.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see #load(Integer)
   * @see app.eeui.framework.extend.integration.glide.signature.ApplicationVersionSignature
   */
  @NonNull
  @CheckResult
  @Override
   ...
   * @return The
   * {@link app.eeui.framework.extend.integration.glide.request.target.Target} used to wrap the given {@link ImageView}.
   */
  @NonNull
   ...
   *               overridden by
   *               {@link app.eeui.framework.extend.integration.glide.request.RequestOptions#override(int, int)} if
   *               previously called.
   ...
   * @see app.eeui.framework.extend.integration.glide.ListPreloader
   */
  @NonNull
