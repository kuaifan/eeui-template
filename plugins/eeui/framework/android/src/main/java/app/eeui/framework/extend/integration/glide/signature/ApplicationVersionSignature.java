package app.eeui.framework.extend.integration.glide.signature;
...
/**
 * A utility class for obtaining a {@link app.eeui.framework.extend.integration.glide.load.Key} signature containing the
...
public final class ApplicationVersionSignature {
  ...
  /**
   * Returns the signature {@link app.eeui.framework.extend.integration.glide.load.Key} for version code of the Application
