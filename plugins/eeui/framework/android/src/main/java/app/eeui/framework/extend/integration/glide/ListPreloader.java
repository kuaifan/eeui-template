...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     * {@link app.eeui.framework.extend.integration.glide.request.RequestOptions#override(int, int)} to do so.
     *
  ...
  /**
   * Constructor for {@link app.eeui.framework.extend.integration.glide.ListPreloader} that accepts interfaces for providing
