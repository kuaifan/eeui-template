...
public class GridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BaseHolder(mInflater.inflate(R.layout.layout_eeui_grid_recyler_item, null));
    }
            ...
            if (view != null) {
                ...
                if (dividerShow) {
                    if (position < columnsSize) {
                        ...
                        eeuiCommon.setViewWidthHeight(mBaseHolder.v_top, -1, dividerWidth);
                    }
                    if (position % columnsSize == 0) {
                        ...
                        eeuiCommon.setViewWidthHeight(mBaseHolder.v_left, dividerWidth, paramsHeight);
                    }
                }else{
                    mBaseHolder.v_top.setVisibility(View.GONE);
                    mBaseHolder.v_left.setVisibility(View.GONE);
