...
import app.eeui.framework.extend.integration.zxing.EncodeHintType;
import app.eeui.framework.extend.integration.zxing.Writer;
import app.eeui.framework.extend.integration.zxing.common.BitMatrix;
import app.eeui.framework.extend.integration.zxing.datamatrix.encoder.DefaultPlacement;
import app.eeui.framework.extend.integration.zxing.Dimension;
import app.eeui.framework.extend.integration.zxing.datamatrix.encoder.ErrorCorrection;
import app.eeui.framework.extend.integration.zxing.datamatrix.encoder.HighLevelEncoder;
import app.eeui.framework.extend.integration.zxing.datamatrix.encoder.SymbolInfo;
import app.eeui.framework.extend.integration.zxing.datamatrix.encoder.SymbolShapeHint;
import app.eeui.framework.extend.integration.zxing.qrcode.encoder.ByteMatrix;
