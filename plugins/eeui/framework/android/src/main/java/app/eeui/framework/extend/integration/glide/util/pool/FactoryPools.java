package app.eeui.framework.extend.integration.glide.util.pool;
 ...
 * created, and that can use the {@link app.eeui.framework.extend.integration.glide.util.pool.FactoryPools.Poolable}
