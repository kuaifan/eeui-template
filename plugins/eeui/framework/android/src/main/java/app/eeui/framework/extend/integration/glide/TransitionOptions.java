...
import app.eeui.framework.extend.integration.glide.request.transition.NoTransition;
import app.eeui.framework.extend.integration.glide.request.transition.TransitionFactory;
import app.eeui.framework.extend.integration.glide.request.transition.ViewAnimationFactory;
import app.eeui.framework.extend.integration.glide.request.transition.ViewPropertyAnimationFactory;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   *
   * @param animator The {@link app.eeui.framework.extend.integration.glide.request.transition.ViewPropertyTransition
   *                 .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * {@link app.eeui.framework.extend.integration.glide.request.transition.Transition} for each request started with these
