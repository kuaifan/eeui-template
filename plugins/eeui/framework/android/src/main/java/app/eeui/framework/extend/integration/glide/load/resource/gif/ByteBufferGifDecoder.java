...
import app.eeui.framework.extend.integration.glide.gifdecoder.GifHeader;
import app.eeui.framework.extend.integration.glide.gifdecoder.GifHeaderParser;
import app.eeui.framework.extend.integration.glide.gifdecoder.StandardGifDecoder;
...
import app.eeui.framework.extend.integration.glide.load.resource.UnitTransformation;
...
/**
 * An {@link app.eeui.framework.extend.integration.glide.load.ResourceDecoder} that decodes {@link
 * app.eeui.framework.extend.integration.glide.load.resource.gif.GifDrawable} from {@link java.io.InputStream} data.
 */
