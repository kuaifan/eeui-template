package app.eeui.framework.extend.integration.glide.gifdecoder;

import static app.eeui.framework.extend.integration.glide.gifdecoder.GifDecoder.STATUS_FORMAT_ERROR;
import static app.eeui.framework.extend.integration.glide.gifdecoder.GifFrame.DISPOSAL_NONE;
import static app.eeui.framework.extend.integration.glide.gifdecoder.GifFrame.DISPOSAL_UNSPECIFIED;
...
/**
 * A class responsible for creating {@link app.eeui.framework.extend.integration.glide.gifdecoder.GifHeader}s from data
