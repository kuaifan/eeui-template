...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
   ...
   * app.eeui.framework.extend.integration.glide.request.Request}. </p>
   */
  @Override
  @Nullable
   ...
   *   on older versions, be sure to call {@link app.eeui.framework.extend.integration.glide.RequestManager#clear(View)} on
