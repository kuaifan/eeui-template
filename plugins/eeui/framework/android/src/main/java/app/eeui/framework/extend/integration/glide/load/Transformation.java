...
public interface Transformation<T> extends Key {
   ...
   * app.eeui.framework.extend.integration.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  app.eeui.framework.extend.integration.glide.request.target.Target#SIZE_ORIGINAL} to indicate the
