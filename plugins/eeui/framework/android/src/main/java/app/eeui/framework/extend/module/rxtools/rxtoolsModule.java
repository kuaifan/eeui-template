...
public class rxtoolsModule {
        ...
        switch (method) {
            ...
            case "registerLocation":
                return RxLocationTool.registerLocation(context,
                        eeuiParams.getParamLong(0, var),
                        eeuiParams.getParamLong(1, var),
                        mLocationChangeListener(eeuiParams.getParamJSCallback(2, var)));
    ...
    public static void RxVibrateTool(Context context, String method, Object... var) {
        ...
        switch (method) {
            case "vibrateOnce":
                RxVibrateTool.vibrateOnce(context, eeuiParams.getParamInt(0, var));
                break;
