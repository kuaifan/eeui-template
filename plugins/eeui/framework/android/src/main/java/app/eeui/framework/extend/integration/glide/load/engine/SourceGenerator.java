...
import app.eeui.framework.extend.integration.glide.load.model.ModelLoader.LoadData;
import app.eeui.framework.extend.integration.glide.util.LogTime;
import java.util.Collections;

/**
 * Generates {@link app.eeui.framework.extend.integration.glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link app.eeui.framework.extend.integration.glide.load.model.ModelLoader ModelLoaders} and the model
