...
public final class MemorySizeCalculator {
  ...
  public static final class Builder {
     ...
     * {@link app.eeui.framework.extend.integration.glide.load.engine.cache.MemoryCache} should be able to hold and
    ...
    /**
     * Sets the number of device screens worth of pixels the
     * {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} should be able to hold and
     * returns this Builder.
     */
     ...
     * taken up by Glide's {@link app.eeui.framework.extend.integration.glide.load.engine.cache.MemoryCache} and
     * {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} put together, and returns
     * this builder.
     */
     ...
     * app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.ArrayPool} to use to store temporary
