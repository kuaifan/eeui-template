...
import app.eeui.framework.extend.integration.glide.load.data.DataRewinder;
import app.eeui.framework.extend.integration.glide.load.data.DataRewinderRegistry;
...
import app.eeui.framework.extend.integration.glide.load.model.ModelLoaderRegistry;
import app.eeui.framework.extend.integration.glide.load.resource.transcode.ResourceTranscoder;
import app.eeui.framework.extend.integration.glide.load.resource.transcode.TranscoderRegistry;
import app.eeui.framework.extend.integration.glide.provider.EncoderRegistry;
import app.eeui.framework.extend.integration.glide.provider.ImageHeaderParserRegistry;
import app.eeui.framework.extend.integration.glide.provider.LoadPathCache;
import app.eeui.framework.extend.integration.glide.provider.ModelToResourceClassCache;
import app.eeui.framework.extend.integration.glide.provider.ResourceDecoderRegistry;
import app.eeui.framework.extend.integration.glide.provider.ResourceEncoderRegistry;
...
public class Registry {
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.resource.gif.GifDrawable} etc).
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link app.eeui.framework.extend.integration.glide.load.data.DataRewinder.Factory} to handle a
  ...
  /**
   * Thrown when no {@link app.eeui.framework.extend.integration.glide.load.model.ModelLoader} is registered for a given
   * model class.
   */
