...
public interface RequestListener<R> {
   ...
   * use {@link app.eeui.framework.extend.integration.glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, app.eeui.framework.extend.integration.glide.request.transition.Transition)}.
   *
