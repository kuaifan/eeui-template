...
import static app.eeui.framework.extend.integration.glide.gifdecoder.GifDecoder.TOTAL_ITERATION_COUNT_FOREVER;
...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param frameTransformation An {@link app.eeui.framework.extend.integration.glide.load.Transformation} that can be
   ...
   * @see #setFrameTransformation(app.eeui.framework.extend.integration.glide.load.Transformation, android.graphics.Bitmap)
   *
