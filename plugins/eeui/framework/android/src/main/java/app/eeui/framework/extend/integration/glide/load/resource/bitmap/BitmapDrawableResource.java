...
/**
 * A {@link app.eeui.framework.extend.integration.glide.load.engine.Resource} that wraps an
 ...
 * given {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} when the resource is
 * recycled. </p>
 */
