...
import app.eeui.framework.extend.integration.glide.load.ImageHeaderParserUtils;
...
import app.eeui.framework.extend.integration.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
import app.eeui.framework.extend.integration.glide.util.LogTime;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "app.eeui.framework.extend.integration.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
   * Indicates the {@link app.eeui.framework.extend.integration.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<DownsampleStrategy> DOWNSAMPLE_STRATEGY =
      Option.memory("app.eeui.framework.extend.integration.glide.load.resource.bitmap.Downsampler.DownsampleStrategy",
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("app.eeui.framework.extend.integration.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * {@link app.eeui.framework.extend.integration.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   ...
   * provided  {@link app.eeui.framework.extend.integration.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match
