...
import app.eeui.framework.extend.integration.glide.load.engine.cache.DiskCacheAdapter;
...
import app.eeui.framework.extend.integration.glide.request.ResourceCallback;
