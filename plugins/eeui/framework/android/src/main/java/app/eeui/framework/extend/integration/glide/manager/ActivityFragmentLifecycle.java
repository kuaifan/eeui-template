...
/**
 * A {@link app.eeui.framework.extend.integration.glide.manager.Lifecycle} implementation for tracking and notifying
...
class ActivityFragmentLifecycle implements Lifecycle {
   ...
   *
   * <p> Note - {@link app.eeui.framework.extend.integration.glide.manager.LifecycleListener}s that are added more than once
