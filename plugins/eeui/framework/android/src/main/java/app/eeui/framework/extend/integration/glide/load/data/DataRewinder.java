...
public interface DataRewinder<T> {
   ...
   * {@link app.eeui.framework.extend.integration.glide.load.data.DataRewinder}s.
   *
   * @param <T> The type of data that the {@link app.eeui.framework.extend.integration.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link app.eeui.framework.extend.integration.glide.load.data.DataRewinder} wrapping the given data.
     */
    @NonNull
     ...
     * {@link app.eeui.framework.extend.integration.glide.load.data.DataRewinder}s for.
     */
    @NonNull
