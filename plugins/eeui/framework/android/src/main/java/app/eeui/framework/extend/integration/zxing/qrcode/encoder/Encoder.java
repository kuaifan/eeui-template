...
package app.eeui.framework.extend.integration.zxing.qrcode.encoder;

import app.eeui.framework.extend.integration.zxing.EncodeHintType;
import app.eeui.framework.extend.integration.zxing.WriterException;
import app.eeui.framework.extend.integration.zxing.common.BitArray;
import app.eeui.framework.extend.integration.zxing.common.CharacterSetECI;
import app.eeui.framework.extend.integration.zxing.common.reedsolomon.GenericGF;
import app.eeui.framework.extend.integration.zxing.common.reedsolomon.ReedSolomonEncoder;
import app.eeui.framework.extend.integration.zxing.qrcode.decoder.ErrorCorrectionLevel;
import app.eeui.framework.extend.integration.zxing.qrcode.decoder.Mode;
