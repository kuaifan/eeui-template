...
/**
 * A collection of static methods for creating new {@link app.eeui.framework.extend.integration.glide.RequestManager}s or
 * retrieving existing ones from activities and fragment.
 */
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting
  static final String FRAGMENT_TAG = "app.eeui.framework.extend.integration.glide.manager";
