...
import app.eeui.framework.extend.module.utilcode.util.Utils;

/**
 * Created by WDM on 2018/3/14.
 */

public class eeuiParams {
    ...
    public static long getParamLong(int i, Object... var) {
        return eeuiParse.parseLong(getParamString(i, var));
    }
    ...
    public static JSCallback getParamJSCallback(int i, Object... var) {
        ...
        if (eeuiParams.getParameter(i, var) instanceof JSCallback) {
            callback = (JSCallback) eeuiParams.getParameter(i, var);
        }
        return callback;
    }
