...
import app.eeui.framework.extend.integration.iconify.internal.IconFontDescriptorWrapper;
...
public class IconDrawable extends Drawable {
    ...
    private app.eeui.framework.extend.integration.iconify.Icon icon;
    ...
    public IconDrawable(Context context, String iconKey) {
        app.eeui.framework.extend.integration.iconify.Icon icon = app.eeui.framework.extend.integration.iconify.Iconify.findIconForKey(iconKey);
        if (icon == null) {
     ...
     */
    public IconDrawable(Context context, app.eeui.framework.extend.integration.iconify.Icon icon) {
        init(context, icon);
    }

    private void init(Context context, app.eeui.framework.extend.integration.iconify.Icon icon) {
