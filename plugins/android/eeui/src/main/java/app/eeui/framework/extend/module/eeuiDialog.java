...
public class eeuiDialog extends Dialog {
    ...
    public eeuiDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public eeuiDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        initView(context);
    }

    public eeuiDialog(Context context) {
        super(context);
        initView(context);
    }
     ...
     */
    public eeuiDialog(Context context, float alpha, int gravity) {
        super(context);
