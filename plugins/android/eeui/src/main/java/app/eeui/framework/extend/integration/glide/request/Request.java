...
/**
 * A request that loads a resource for an {@link app.eeui.framework.extend.integration.glide.request.target.Target}.
 */
public interface Request {
   ...
   * {@link app.eeui.framework.extend.integration.glide.request.target.Target}s (for example). Using a similar but different
