...
import app.eeui.framework.extend.integration.iconify.internal.ParsingUtil;
...
public class Iconify {
     ...
     */
    public static IconFontDescriptorWrapper findTypefaceOf(app.eeui.framework.extend.integration.iconify.Icon icon) {
     ...
     */
    public static app.eeui.framework.extend.integration.iconify.Icon findIconForKey(String iconKey) {
        for (int i = 0, iconFontDescriptorsSize = iconFontDescriptors.size(); i < iconFontDescriptorsSize; i++) {
            ...
            app.eeui.framework.extend.integration.iconify.Icon icon = iconFontDescriptor.getIcon(iconKey);
