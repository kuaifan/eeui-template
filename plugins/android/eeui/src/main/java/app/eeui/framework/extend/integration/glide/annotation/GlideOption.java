 ...
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions}.
 *
 * <p>All annotated methods will be added to a single
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions} implementation generated per application.
 ...
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions} object with one or more methods called on it.
 * You must not return a newly instantiated {@code app.eeui.framework.extend.integration.glide.request.RequestOptions} object
 * as doing so my cause a {@code ClassCastException} at runtime. Calling either
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions#autoClone()} or
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions#lock()} is safe, but unnecessary and should
 ...
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions} object is cloned before it is passed to this
 * method to avoid an option method returning a new instance, but using methods like
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions#clone()} or
 * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions#autoClone()} can result in options applied in
...
public @interface GlideOption {
   ...
   * {@code app.eeui.framework.extend.integration.glide.request.RequestOptions#autoClone()}.
   *
   ...
   * with {@code app.eeui.framework.extend.integration.glide.RequestBuilder#apply}. The static factory method by default
   * simply creates a new {@code app.eeui.framework.extend.integration.glide.request.RequestOptions} object, calls the
