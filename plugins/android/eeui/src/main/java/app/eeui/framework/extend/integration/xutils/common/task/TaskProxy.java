package app.eeui.framework.extend.integration.xutils.common.task;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((app.eeui.framework.extend.integration.xutils.common.Callback.CancelledException) args[0]);
                        break;
                    }
